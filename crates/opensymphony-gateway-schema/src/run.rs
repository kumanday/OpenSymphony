...
pub struct RunDetail {
    ...
    /// Sanitized repository and parent lifecycle facts. Absent facts remain
    /// absent instead of being inferred by clients.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub operator: Option<RunOperatorSnapshot>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RunOperatorSnapshot {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub leases: Vec<RunLeaseSnapshot>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub repairs: Vec<RunRepairSnapshot>,
    pub memory: Option<RunMemorySnapshot>,
    pub containment: Option<RunContainmentSnapshot>,
    pub provider: Option<RunProviderSnapshot>,
    pub verification: Option<RunVerificationSnapshot>,
    pub cleanup: Option<RunCleanupSnapshot>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RunRepositorySnapshot {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RunContainmentSnapshot {
    pub requested_scope: Option<String>,
    pub effective_containment: String,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RunProviderSnapshot {
    pub provider: String,
    pub step: String,
    pub status: String,
}
