...
export const codeGraphFixtureDiffOverlays: CodeDiffOverlay[] = [{
  ...
  edge_deltas: [{
    edge_key: "fixture-edge-added",
    status: "added",
    before: null,
    after: {
      edge_id: "fixture-edge-added-head",
      kind: "call",
      source_symbol_key: "codeGraphReducer",
      target_symbol_key: "newSymbol",
      target_hint: "newSymbol()",
      confidence: "exact",
      unresolved: false,
      path: "packages/graph/src/code-graph.ts",
      span: { start_line: 81, start_col: 2, end_line: 81, end_col: 12 },
    },
  }],
  module_connection_deltas: [{
    connection_key: "fixture-connection-added",
    scope: "directory",
    source: "packages/graph/src",
    target: "packages/graph/src",
    status: "added",
    before: null,
    after: {
      edge_count: 1,
      edge_kind_counts: [{ kind: "call", count: 1 }],
      confidence_counts: [{ confidence: "exact", count: 1 }],
      unresolved_count: 0,
    },
  }],
  blast_radius: [{
    symbol_key: "graphReducer",
    inbound_count: 2,
    outbound_count: 1,
    inbound: [
      { edge_key: "fixture-radius-inbound-1", symbol_key: "run", path: "packages/graph/src/run.ts", edge_kind: "call", confidence: "syntactic", distance: 1 },
      { edge_key: "fixture-radius-inbound-2", symbol_key: "render", path: "packages/ui-core/src/app-shell.ts", edge_kind: "reference", confidence: "heuristic", distance: 1 },
    ],
    outbound: [
      { edge_key: "fixture-radius-outbound-1", symbol_key: "newSymbol", path: "packages/graph/src/code-graph.ts", edge_kind: "call", confidence: "exact", distance: 1 },
    ],
  }],
  unanalyzed_files: [],
  truncation: { nodes_dropped: 0, edges_dropped: 0, reason: null },
