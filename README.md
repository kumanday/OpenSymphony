...
- `opensymphony-workflow` loads `WORKFLOW.md`, rejects unknown top-level sections, applies defaults and env/path resolution, and renders prompts with strict template failures
