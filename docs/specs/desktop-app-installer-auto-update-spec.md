...
packaging or real asset publication.
...
`cargo build --release` from `apps/desktop/src-tauri`, copies the resulting
`OpenSymphony` executable into a staging bundle, writes
