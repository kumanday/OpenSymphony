...
- `crates/opensymphony-openhands/tests/fake_server_contract.rs` locks in attach, scripted initial snapshot replay, scripted attach-backlog versus buffered-live ordering, scripted reconnect exhaustion and explicit-close handling, reconcile, out-of-order insertion, and reconnect recovery against `opensymphony-testkit`
