...
- `cargo test --lib opensymphony_workspace::manager::tests::discover_agents_ignores_generated_trees_with_only_tracked_non_instructions` and the memory scope tests cover bounded tracked-instruction probes and project-scoped direct capsule reads
