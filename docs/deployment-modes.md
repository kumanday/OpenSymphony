...
- COE-402 contributed: PR #104: COE-402: App Shell, Dashboard, Task Graph, And Run Views
- COE-403 contributed: PR #103: feat(ui-core): terminal and log renderer prototype (COE-403) (merge `45f744b`)
- COE-404 contributed: PR #93: feat: add Tauri desktop shell and security capabilities (COE-398) (merge `6641d8d`)
